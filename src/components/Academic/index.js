    ...
    professionally experienced teachers, to help educators progress a younger child's education.</p>
     ...
     <Col
      ...
      <div className='only-card-hover'> 
            ...
            <h2 className='title-card-academic-title'>Maharashtra State Board</h2>
            <small></small>
      ...
      >
       <AnimationOnScroll animateIn="animate__zoomIn " animateOnce={true}>
           ...
           <h2 className='title-card-academic-title'>CBSE Board</h2>
           <small></small>
            <ul className='list-academic'>
      ...
      >
       ...
       <div className='only-card-hover'> 
            ...
            <h2 className='title-card-academic-title'>Pre - School</h2>
            <ul className='list-academic'>
                <li>Play Group </li>
                <li> Nursery</li>
                <li> Junior kg</li>
    ...
    <Col
      ...
      >
       ...
       <div className='only-card-hover'> 
            ...
            <h2 className='title-card-academic-title'>Educational App</h2>
            <ul className='list-academic'>
